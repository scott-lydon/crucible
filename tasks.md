...
- [ ] **slice-15-dashboard-spa** (M). Wire the PR #1 frontend to the backend routes and SSE; land the deferred per-oracle tables and the held-out persist lifecycle.

## Next slice

- [ ] **slice-16-corpus-export** (M). JSONL streamer of successful attacks; `/corpus` download with row count equal to the table count.
